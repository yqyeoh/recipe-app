...
function IngredientInputs({ ingredients, handleDelete, addIngredient, ingredientOptions, handleIngredientInputChange, handleIngredientSelectChange, handleCreateIngredientOption, error }) {
  ...
  return (
    <React.Fragment>
      ...
      {ingredients.map((ingredient, index) => {
        ...
        return (
          <div className="row mb-2" data-testid="ingredients-row" key={index}>
            ...
            <div className="col-sm-1">
              <button type="button" className="btn btn-danger btn deleteBtn" data-testid={deleteId} id={deleteId} onClick={(e) => handleDelete(index, e)} name="ingredients">Delete</button>
            </div>
          </div>
      ...
      <button type="button" className="btn btn-success btn mb-2" onClick={addIngredient}>Add New Ingredient</button>
    </React.Fragment>
