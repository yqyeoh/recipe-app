let recipes = [
    {
        ...
        servings: 5,
        ingredients: [
            { ingredientName: "chicken breast halves", extraDescription: "skinless, boneless", qty: "4", unit: ""},
...
9. Bake in the preheated oven until cheese is browned and bubbly, and chicken breasts are no longer pink in the center, 15 to 20 minutes. An instant-read thermometer inserted into the center should read at least 165 degrees F (74 degrees C).`
    },
    {
        ...
        servings: 4,
        ingredients: [
            { ingredientName: "beef stew meat", extraDescription: "cubed", qty: "2", unit: "lb", },
            { ingredientName: "beef bouillon", extraDescription: "crumbled", qty: "4", unit: "cubes", },
            { ingredientName: "vegetable oil", qty: "3", unit: "tbsp" },
            ...
            { ingredientName: "corn starch", extraDescription: "", qty: "2", unit: "tsp" },
            { ingredientName: "black pepper", extraDescription: "ground", qty: "1/2", unit: "tbsp" },
            { ingredientName: "rosemary", extraDescription: "dried", qty: "1", unit: "tsp" },
            { ingredientName: "parsley", extraDescription: "dried", qty: "1", unit: "tsp" }],        
        instructions:
...
2.Stir potatoes, carrots, celery, and onion into the pot. Dissolve cornstarch in 2 teaspoons cold water and stir into stew. Cover and simmer 1 hour more.`
    },
    {
        ...
        ingredients: [
            ...
            { ingredientName: "lime juice", extraDescription: "", qty: "2", unit: "tbsp" },
...
3.Arrange shrimp on grill and baste with marinade (dab some mint and shallot onto shrimp); close lid. Cook until shrimp are just beginning to brown, 1 to 2 minutes. Turn shrimp over, baste again, and close lid. Cook 1 to 2 minutes until browned but still moist in center (cut to check). Transfer shrimp to a platter, drizzle with lime juice, and garnish with mint sprigs.`
    },
    {
        ...
        servings: 4-6,
        ingredients: [
            { ingredientName: "rice", extraDescription: "a day old", qty: "3", unit: "bowl", },
            { ingredientName: "dried shrimp", extraDescription: "", qty: "1", unit: "small handful", isOptional:true },
            { ingredientName: "spicy ketchup", extraDescription: "", qty: "2", unit: "tbsp" },
            { ingredientName: "chilli sauce", extraDescription: "", qty: "1", unit: "tbsp" },
            { ingredientName: "peanut oil", extraDescription: "", qty: "2", unit: "tbsp"},
            { ingredientName: "eggs", extraDescription: "lightly beaten", qty: "3", unit: ""},
            { ingredientName: "ginger", extraDescription: "peeled & grated", qty: "1", unit: "tbsp"},
            { ingredientName: "carrot", extraDescription: "", qty: "1", unit: ""},
            { ingredientName: "char siew", extraDescription: "cooked", qty: "4", unit: "oz"},
            { ingredientName: "shitake mushroom", extraDescription: "stemmed & diced", qty: "3", unit: ""},
            { ingredientName: "frozen peas", extraDescription: "", qty: "1", unit: "cup"},
            { ingredientName: "light soy sauce", extraDescription: "", qty: "1-2", unit: "tbsp"},
            { ingredientName: "sea salt", extraDescription: "", qty: "", unit: ""},
            { ingredientName: "white pepper", extraDescription: "freshly ground", qty: "1-2", unit: "tbsp"},
            { ingredientName: "sesame oil", extraDescription: "", qty: "1", unit: "tsp"},
            { ingredientName: "spring onion", extraDescription: "sliced on a diagonal, for garnish", qty: "1-2", unit: ""},],
        timeRequired: "40",
        instructions:
...
4. Add the remaining 1 tablespoon peanut oil to the wok. Add the ginger and stir-fry for less than 1 minute. Then add the carrots and stir-fry for 1 minute more. Add the pork, the soaked dried shrimp if using, and mushrooms and cook for 2 minutes. Then add the peas and cooked rice and toss together. Add the cooked egg back into the wok. Season the mixture with the light soy sauce, salt and pepper. At the very end add the sesame oil and spicy ketchup sauce if using. Check the seasoning and adjust to taste with salt and pepper. Garnish with green onions and serve immediately.`
    },
    {
        ...
        servings: 4,
        ingredients: [
            { ingredientName: "kecap manis", extraDescription: "", qty: "3", unit: "tbsp", },
            { ingredientName: "oyster sauce", extraDescription: "", qty: "3", unit: "tbsp" },
            { ingredientName: "caster sugar", extraDescription: "", qty: "3", unit: "tbsp" },
            { ingredientName: "crab", extraDescription: "", qty: "2", unit: "kg" },
            { ingredientName: "oil", extraDescription: "", qty: "1 1/2", unit: "tbsp"},
            { ingredientName: "butter", extraDescription: "", qty: "1 1/2", unit: "tbsp" , isOptional:true },
            { ingredientName: "ginger", extraDescription: "grated", qty: "1 1/2", unit: "tbsp"},
            { ingredientName: "garlic", extraDescription: "finely chopped", qty: "6", unit: "clove"},
            { ingredientName: "red chilli", extraDescription: "finely chopped", qty: "1-2", unit: "" },
            { ingredientName: "black pepper", extraDescription: "", qty: "1 1/2", unit: "tbsp" },
            { ingredientName: "white pepper", extraDescription: "", qty: "1 1/2", unit: "tbsp" },
            { ingredientName: "ground coriander", extraDescription: "", qty: "1/4", unit: "tsp" },
            { ingredientName: "spring onion", extraDescription: "finely chopped", qty: "2", unit: "" },
            { ingredientName: "fresh coriander", extraDescription: "fresh", qty: "1/4", unit: "cup" },],
        timeRequired: "40",
        instructions:
...
8.Cook a further 2-3 minutes to finish cooking the crab then garnish with the spring onions and coriander leaves.`
    },
    {
        ...
        servings: 4,
        ingredients: [
            { ingredientName: "salmon fillet", extraDescription: "", qty: "1 1/2", unit: "lb", },
            { ingredientName: "olive oil", extraDescription: "", qty: "1", unit: "tbsp" },
            { ingredientName: "seafood seasoning", extraDescription: "", qty: "1", unit: "tsp" },
            { ingredientName: "black pepper", extraDescription: "ground", qty: "1", unit: "tsp" },
            { ingredientName: "ginger", extraDescription: "peeled & thinly sliced", qty: "1", unit: "inch"},
            { ingredientName: "garlic", extraDescription: "finely chopped", qty: "6", unit: "clove"},
            { ingredientName: "lime", extraDescription: "thinly sliced", qty: "1", unit: "" }],
        timeRequired: "30",
        instructions:
...
3. Broil salmon until hot and beginning to turn opaque, about 10 minutes; watch carefully. If broiler has a High setting, turn broiler to that setting and continue broiling until salmon is cooked through and flakes easily with a fork, 5 to 10 more minutes.`
    },
    {
        ...
        servings: 4,
        ingredients: [
            { ingredientName: "coconut oil", extraDescription: "", qty: "2", unit: "tbsp", },
            { ingredientName: "chicken breast halves", extraDescription: "skinless, boneless, cut into small", qty: "16", unit: "oz" },
            { ingredientName: "coconut cream", extraDescription: "", qty: "14", unit: "oz" },
            { ingredientName: "red thai curry sauce", extraDescription: "", qty: "1", unit: "btl" },
            { ingredientName: "dried rice stick vermicelli noodles", extraDescription: "", qty: "16", unit: "oz"}],
        timeRequired: "30",
        instructions:
...
3. Reduce skillet heat to simmer. Add the noodles and let simmer until flavors are absorbed, about 5 minutes. Divide chicken and noodles among individual serving bowls.`
    },
    {
        ...
        servings: 4,
        ingredients: [
            { ingredientName: "corn starch", extraDescription: "", qty: "2", unit: "tbsp", },
            { ingredientName: "water", extraDescription: "", qty: "1 1/2", unit: "tbsp" },
            { ingredientName: "chicken broth", extraDescription: "", qty: "6", unit: "cup" },
            { ingredientName: "soy sauce", extraDescription: "", qty: " 2 1/2", unit: "tbsp" },
            { ingredientName: "fish sauce", extraDescription: "", qty: "1", unit: "tbsp"},
            { ingredientName: "rice vinegar", extraDescription: "", qty: "1", unit: "tbsp"},
            { ingredientName: "chile-garlic sauce", extraDescription: "or more to taste", qty: "1", unit: "tbsp"},
            { ingredientName: "vegetable oil", extraDescription: "", qty: "2", unit: "tsp"},
            { ingredientName: "garlic", extraDescription: "minced", qty: "2", unit: "clove"},
            { ingredientName: "ground coriander", extraDescription: "", qty: "1", unit: "tsp"},
            { ingredientName: "rice noodle", extraDescription: "thick", qty: "16", unit: "oz"},
            { ingredientName: "zucchini", extraDescription: "sliced", qty: "1", unit: "cup"},
            { ingredientName: "red bell pepper", extraDescription: "sliced", qty: "1", unit: "cup"},
            { ingredientName: "chicken breast halves", extraDescription: "cooked, cut into 1-inch cube", qty: "2", unit: ""},
...
3. Remove from heat and let stand, covered, for 5 minutes to thicken. Serve garnished with crushed peanuts and cilantro.
    ...
    },
    {
        ...
        servings: 4,
        ingredients: [
            { ingredientName: "scallion", extraDescription: "trimmed", qty: "2", unit: "bunch", },
            { ingredientName: "olive oil", extraDescription: "", qty: "1", unit: "tbsp" },
            { ingredientName: "kosher salt", extraDescription: "divided", qty: "3/4", unit: "tsp" },
            { ingredientName: "arctic char", extraDescription: "skinless", qty: "4", unit: "6 oz" },
            { ingredientName: "dijon mustard", extraDescription: "", qty: "2", unit: "tbsp"},
            { ingredientName: "sesame oil", extraDescription: "", qty: "2", unit: "tbsp"},
            { ingredientName: "ginger", extraDescription: "grated", qty: "1", unit: "tbsp"},
...
3. Nestle fish among scallions and broil until fish is just cooked through and scallions are charred in spots, 6 to 10 minutes. Serve with steamed rice, if desired.`
    },
    {
        ...
        servings: 4,
        ingredients: [
            { ingredientName: "fettuccinne pasta", extraDescription: "dry", qty: "12", unit: "oz", },
            { ingredientName: "red bell pepper", extraDescription: "julienned", qty: "2", unit: "" },
            { ingredientName: "garlic", extraDescription: "minced", qty: "3", unit: "clove" },
            { ingredientName: "cayenne pepper", extraDescription: "", qty: "3/4", unit: "tsp" },
            { ingredientName: "sour cream", extraDescription: "reduced fat", qty: "1", unit: "cup"},
            { ingredientName: "chicken broth", extraDescription: "", qty: "3/4", unit: "cup"},
            { ingredientName: "parmesan cheese", extraDescription: "grated", qty: "3/4", unit: "cup"},
            { ingredientName: "salt", extraDescription: "to taste", qty: "", unit: ""},
            { ingredientName: "pepper", extraDescription: "to taste", qty: "", unit: ""}],
        timeRequired: "15",
        instructions:
